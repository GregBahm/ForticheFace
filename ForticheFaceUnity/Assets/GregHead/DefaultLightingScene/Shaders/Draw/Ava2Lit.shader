Shader "Microsoft/Mesh Avatars/Ava2/Draw/Lit"
{
    Properties
    {
        ...
        _BackScatterTexture("Scatter Texture", 2D) = "black" {}
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define ENABLE_BACKSCATTER
            #define SPEC_GLOSS_MAP
            #define BAKED_NORMALS
            // #define DISABLE_LINEAR_HACKS // uncomment this to disable linear hacks

            #include "../Includes/HLSL/Ava2LitInput.hlsl"
            #include "../Includes/HLSL/Ava2LitForwardPass.hlsl"

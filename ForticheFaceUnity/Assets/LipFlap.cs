...
public class LipFlap : MonoBehaviour
{
    ...
    private void Start()
    {
        mouthOpen = new BlendWrapper("Mouth_Open", headRenderer);
        mouthRight = new BlendWrapper("Jaw_Chew_Right", headRenderer);
        mouthLeft = new BlendWrapper("Jaw_Chew_Left", headRenderer);
        mouthUp = new BlendWrapper("Chin_Raised", headRenderer);
    }
    ...
    private class BlendWrapper
    {
        ...
        public BlendWrapper(string name, SkinnedMeshRenderer renderer)
        {
            this.renderer = renderer;
            index = GetBlendIndex(name);
        }
